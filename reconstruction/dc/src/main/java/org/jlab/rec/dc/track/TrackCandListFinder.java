...
public class TrackCandListFinder {
     ...
     */
    public List<Track> getTrackCandsHB(CrossList crossList, DCGeant4Factory DcDetector, double TORSCALE, Swim dcSwim) {
            ...
            if (aCrossList.size() == 3 && Math.abs(TORSCALE) < 0.001) {
                ...
                if (cand.get_pAtOrig() != null) {
                    ...
                    if (!kFit.setFitFailed && kFit.finalStateVec != null) {
                        ...
                        this.setTrackParsHB(cand, traj, trjFind, fn, kFit.finalStateVec.z, DcDetector, dcSwim);
...
//                                kFit.totNumIter=30;
     ...
     * @param dcSwim
     */
    public void setTrackParsHB(Track cand,
                             Trajectory traj,
